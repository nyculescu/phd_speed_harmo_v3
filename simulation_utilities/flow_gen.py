...
def flow_generation(base_traffic_jam_exponent, day_index, model, idx):
    ...
    with open(f"./sumo/generated_flows_{model}_{idx}.rou.xml", "w") as f:
        ...
        with open(f"./sumo/generated_flows_{model}_{idx}.rou.xml", "w") as f:
            ...
            f.write(f'    <vType id="passenger" accel="2.6" decel="4.5" sigma="{np.random.uniform(0.1, 0.5)}" length="4.5" maxSpeed="180" color="1,0,0" personNumber="{(int)(np.random.uniform(1, 5))}" emissionClass="HBEFA4/PC_petrol_Euro-4"/>\n')
            f.write(f'    <vType id="passenger/hatchback" accel="3.2" decel="4.9" sigma="{np.random.uniform(0.1, 0.7)}" length="4.2" maxSpeed="240" color="0.8,0.8,0" personNumber="{(int)(np.random.uniform(1, 3))}" emissionClass="HBEFA4/PC_petrol_Euro-5"/>\n')
            f.write(f'    <vType id="passenger/van" accel="1.8" decel="3.2" sigma="{np.random.uniform(0.1, 0.5)}" length="6.2" maxSpeed="130" color="1,1,1" personNumber="{(int)(np.random.uniform(1, 12))}" emissionClass="HBEFA4/PC_petrol_Euro-5"/>\n')
            f.write(f'    <vType id="bus" accel="1.2" decel="3.8" sigma="{np.random.uniform(0.1, 0.3)}" length="12.0" maxSpeed="100" color="1,.5,.5" personNumber="{(int)(np.random.uniform(1, 40))}" emissionClass="HBEFA4/UBus_Artic_gt18t_Euro-VI_A-C"/>\n')
            f.write(f'    <vType id="motorcycle" accel="3.8" decel="6.2" sigma="{np.random.uniform(0.1, 0.4)}" length="2.2" maxSpeed="180" color=".2,.2,.8" personNumber="{(int)(np.random.uniform(1, 2))}" emissionClass="HBEFA4/PC_petrol_Euro-6ab"/>\n')
            f.write(f'    <vType id="truck" accel="1.1" decel="3.1" sigma="{np.random.uniform(0.1, 0.4)}" length="6" maxSpeed="100" color=".4,.1,.4" personNumber="{(int)(np.random.uniform(1, 3))}" emissionClass="HBEFA4/RT_le7.5t_Euro-VI_A-C"/>\n')
            f.write(f'    <vType id="truck/trailer" accel="1.1" decel="3.1" sigma="{np.random.uniform(0.1, 0.3)}" length="10.5" maxSpeed="100" color=".4,.4,.4" personNumber="{(int)(np.random.uniform(1, 2))}" emissionClass="HBEFA4/RT_le7.5t_Euro-VI_A-C"/>\n')

            f.write(f'    <vType id="disobedient_passenger" accel="2.6" decel="4.5" length="4.5" maxSpeed="180" color="1,0,0" personNumber="{(int)(np.random.uniform(1, 5))}" sigma="1.0" speedFactor="1.2" speedDev="0.2" lcStrategic="0.5" lcCooperative="0.1" lcSpeedGain="1.5" emissionClass="HBEFA4/PC_petrol_Euro-6ab"/>\n')
            f.write(f'    <vType id="disobedient_passenger/hatchback" accel="3.2" decel="4.9" length="4.2" maxSpeed="240" color="0.8,0.8,0" personNumber="{(int)(np.random.uniform(1, 3))}" sigma="1.0" speedFactor="1.2" speedDev="0.2" lcStrategic="0.5" lcCooperative="0.1" lcSpeedGain="1.5" emissionClass="HBEFA4/PC_petrol_Euro-6ab"/>\n')
            f.write(f'    <vType id="disobedient_passenger/van" accel="1.8" decel="3.2" length="6.2" maxSpeed="130" color="1,1,1" personNumber="{(int)(np.random.uniform(1, 12))}" sigma="1.0" speedFactor="1.2" speedDev="0.2" lcStrategic="0.5" lcCooperative="0.1" lcSpeedGain="1.5" emissionClass="HBEFA4/PC_petrol_Euro-6ab"/>\n')
            f.write(f'    <vType id="disobedient_bus" accel="1.2" decel="3.8" length="12.0" maxSpeed="100" color="1,.5,.5" personNumber="{(int)(np.random.uniform(1, 40))}" sigma="1.0" speedFactor="1.2" speedDev="0.2" lcStrategic="0.5" lcCooperative="0.1" lcSpeedGain="1.5" emissionClass="HBEFA4/UBus_Artic_gt18t_Euro-VI_A-C"/>\n')
            f.write(f'    <vType id="disobedient_motorcycle" accel="3.8" decel="6.2" length="2.2" maxSpeed="180" color=".2,.2,.8" personNumber="{(int)(np.random.uniform(1, 2))}" sigma="1.0" speedFactor="1.2" speedDev="0.2" lcStrategic="0.5" lcCooperative="0.1" lcSpeedGain="1.5" emissionClass="HBEFA4/PC_petrol_Euro-6ab"/>\n')
            f.write(f'    <vType id="disobedient_truck" accel="1.1" decel="3.1" length="6" maxSpeed="100" color=".4,.1,.4" personNumber="{(int)(np.random.uniform(1, 3))}" sigma="1.0" speedFactor="1.2" speedDev="0.2" lcStrategic="0.5" lcCooperative="0.1" lcSpeedGain="1.5" emissionClass="HBEFA4/RT_le7.5t_Euro-VI_A-C"/>\n')
            f.write(f'    <vType id="disobedient_truck/trailer" accel="1.1" decel="3.1" length="10.5" maxSpeed="100" color=".4,.4,.4" personNumber="{(int)(np.random.uniform(1, 2))}" sigma="1.0" speedFactor="1.2" speedDev="0.2" lcStrategic="0.5" lcCooperative="0.1" lcSpeedGain="1.5" emissionClass="HBEFA4/RT_le7.5t_Euro-VI_A-C"/>\n')
